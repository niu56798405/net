...
public class PlayerContext {
    ...
    private static class PlayerCollection {
        ConcurrentLinkedHashMap<Long, PlayerData> context = new ConcurrentLinkedHashMap.Builder<Long, PlayerData>().maximumWeightedCapacity(5000).build();
        
        public Player get(long playerId) {
            PlayerData item = context.get(playerId);
            if(item == null) {
                return null;
            }
	...
	public ActionExecutor geActionExecutor(){
		return executor;
	}	
}
