 ...
 * @author niu
 */
public abstract class IKcpClient implements Output, KcpListerner, Runnable {
			...
			protected void initChannel(NioDatagramChannel ch) throws Exception {
				...
				cp.addLast(new ChannelInboundHandlerAdapter() {
					...
					public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
						...
						IKcpClient.this.onReceive(dp);
					}

					@Override
					public void exceptionCaught(ChannelHandlerContext ctx, Throwable cause) throws Exception {
						IKcpClient.this.handleException(cause, null);
						IKcpClient.this.close();
					}
				});
			}
		});
