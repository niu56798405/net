...
//  private final Map<Object, Object> session;
  ...
  private Session kcpSession;
  
  public Session getKcpSession() {
	return kcpSession;
  }

  public void setKcpSession(Session kcpSession) {
...
//      this.release();
 ...
 public void input(ByteBuf content)
  ...
  public void setClosed(boolean boo){
	  closed = boo;
  }
